...
import { Lesson, CourseCategory, QuizQuestion, SlideContent } from '@/app/types';
        ...
        try {
            ...
            if (thumbnailFile) {
                ...
                try {
                    ...
                    thumbnailUrl = await uploadCourseThumbnail(compressed);
                } catch (uploadError) {
            ...
            for (let i = 0; i < validLessons.length; i++) {
                ...
                if (l.type === 'video' && l.videoSource === 'upload' && l.videoFile) {
                    ...
                    try {
                        const url = await uploadCourseVideo(l.videoFile);
                        l.videoUrl = url;
                    } catch (err) {
                ...
                if (l.type === 'slides' && l.slidesFile) {
                    ...
                    try {
                        const url = await uploadCoursePPTX(l.slidesFile);
                        l.slidesFileUrl = url;
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-lg text-xs font-bold transition-all ${lesson.type === 'slides'
