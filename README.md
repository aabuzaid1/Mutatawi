...
- كورسات تعليمية متكاملة بدروس فيديو وأنشطة.
- إمكانية **رفع الفيديوهات محلياً** (حتى 500 ميجابايت) للمنصة لتجاوز الاعتماد على منصات خارجية.
- دعم الأنشطة التفاعلية مع إمكانية إضافة نصوص مخصصة ورفع صور للمواد التعليمية.
- تتبع مستمر لتقدم المتعلم ونظام إنجاز الدورات.
- تقنية إدارة وسائط قوية عبر **Firebase Storage**.

### 🤖 المساعد الذكي "حنظلة" (Hanzala AI)
- مساعد دراسي متقدم يدعم اللغتين **العربية والإنجليزية** مع إدراك تلقائي لتفضيلات المستخدم.
- **تحليل الصور (Multimodal)**: إمكانية رفع صور للمسائل أو النصوص المكتوبة ليقوم حنظلة بتحليلها وحلها خطوة بخطوة.
- **إدخال صوتي**: التحدث وإرسال الاستفسارات صوتياً إلى المساعد.
- **تصدير النتائج**: تصدير المحادثات والملخصات مباشرة لملفات احترافية (PDF, DOCX, PPTX).
- **نظام التبديل التلقائي لضمان الموثوقية (Failover)**: استخدام مدمج لواجهات (Gemini و Kimi APIs) لضمان استمرارية الخدمة حتى عند ضغط الطلبات.

### 🎨 واجهة مستخدم متقدمة وهُوية بصرية
- تدمج المنصة هوية بصرية مخصصة عبر **إضافة أعلام فلسطين والأردن** للتعبير عن هوية المنصة المحلية.
- تجربة مستخدم (UX) سلسة ومتجاوبة بشكل عالي الدقة على جميع الشاشات (موبايل، تابلت، أجهزة مكتبية).
...
| **Gemini & Kimi APIs** | تشغيل المساعد الذكي "حنظلة" وتحليل الصور والنصوص للطلاب |
